...
const ViewProductInventory = () => {
  ...
  const responseData = {
    ...
    createdAt: "2023-08-27T13:58:54.380Z",
    updatedAt: "2023-08-27T13:58:54.380Z",
  };
  return (
    <Box>
      <Dashboard>
                ...
                <Grid item xs={4}>
                  <Box className="productInventory_textFieldContainer">
                    <CustomTextField
                      ...
                      label="Product title"
                      name="product_title"
                      value={responseData.product.product_title}
                      disabled={true}
                    />
                  </Box>
                </Grid>
                <Grid item xs={4}>
                  <Box className="productInventory_textFieldContainer">
                    <CustomTextField
                      ...
                      name="quantity"
                      value={responseData.quantity.toString()}
                      disabled={true}
                    />
                  </Box>
                </Grid>
                ...
                <Grid item xs={4}>
                  <Box className="productInventory_textFieldContainer">
                    <CustomTextField
                      ...
                      label="Product size"
                      name="product_size"
                      value={responseData.product.product_size}
                      disabled={true}
                    />
                  </Box>
                </Grid>
                <Grid item xs={4}>
                  <Box className="productInventory_textFieldContainer">
                    <CustomTextField
                      ...
                      value={responseData.product.product_MRP_price.toString()}
                      disabled={true}
                    />
                  </Box>
                </Grid>
                <Grid item xs={4}>
                  <Box className="productInventory_textFieldContainer">
                    <CustomTextField
                      ...
                      name="product_price"
                      disabled={true}
                      value={responseData.product.product_price.toString()}
                    />
                  </Box>
                </Grid>
                <Grid item xs={4}>
                  <Box className="productInventory_textFieldContainer">
                    <CustomTextField
                      ...
                      disabled={true}
                      value={
                        responseData.product.product_sub_category
                          .sub_category_name
                      }
                    />
                  </Box>
                ...
                <Grid item xs={8}>
                  <Box className="productInventory_textFieldContainer">
                    <CustomTextField
                      ...
                      disabled={true}
                      multiline={true}
                      value={responseData.product.product_description}
                    />
                  </Box>
                </Grid>
                <Grid item xs={4}>
                  <Box className="productInventory_textFieldContainer">
                    <CustomTextField
                      ...
                      label="Product brand"
                      name="product_brand"
                      value={responseData.product.product_brand.brand_name}
                      disabled={true}
                    />
                  </Box>
                  <Box className="productInventory_textFieldContainer">
                    <CustomTextField
                      ...
                      name="is_vegetarian"
                      disabled={true}
                      value={responseData.product.is_vegetarian ? "Yes" : "No"}
                    />
                  </Box>
                </Grid>
                <Grid item xs={12}>
